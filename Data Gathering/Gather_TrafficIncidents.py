...
if __name__=="__main__":
    ...
    SQLCommand = ("INSERT INTO TrafficIncidents"
                 "(CurrentDate, CurrentTime, Latitude, Longitude, Message, Type) "
                "VALUES (?,?,?,?,?,?)")
    ...
    while True:
        ...
        if skip == 0:
            ...
            #Save result to file
            with open("IncidentsTraffic.json","a") as outfile:
                #Saving jsonObj["d"]
...
#                            jsonObj["RoadName"], 
#                            jsonObj["SpeedBand"]])
                    Values = [date,currenttime,jsonObj["Latitude"],jsonObj["Longitude"],jsonObj["Message"],jsonObj["Type"]]
